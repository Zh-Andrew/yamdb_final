# Generated by Django 2.2.16 on 2022-07-31 17:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='user', max_length=10, verbose_name='Пользовательские роли')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Наименование')),
                ('year', models.IntegerField(validators=[reviews.validators.year_validation], verbose_name='Год создания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Оценка может выставляться в диапазоне от 1 до 10'), django.core.validators.MinValueValidator(1, 'Оценка может выставляться в диапазоне от 1 до 10')], verbose_name='Рейтинг')),
